  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeate flex items-center justify-center'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
        ...
        <textarea onChange={(e)=>setBio(e.target.value)} value={bio} rows={4} placeholder='Bio' className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500'></textarea>
        <button type='submit' className='py-3 bg-gradient-to-r from-purple-400 to-violet-600 text-white rounded-full cursor-pointer text-lg'>Save Changes</button>
      </form>
