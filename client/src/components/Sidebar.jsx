...
const Sidebar = () => {
    // earlier we were getting users and getUsers from the porps
        ...
        <div className='pb-5'>
            ...
            <div className='flex flex-col'>
                {filteredUsers.map((user,index)=>(
                    ...
                    key={index}
                    className={`relative flex items-center gap-2 p-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser?._id===user._id &&'bg-[#282142]/50'}`}>
